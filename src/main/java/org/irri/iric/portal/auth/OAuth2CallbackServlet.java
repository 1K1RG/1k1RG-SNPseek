...
public class OAuth2CallbackServlet extends HttpServlet {
	...
	private static final String CLIENT_ID = "<insert>";
	private static final String TENANT_ID = "<insert>";
	private static final String SECRET = "<insert>";
	private static final String REDIRECT_URI = "https://snpseek.irri.org/callback"; // Make sure this matches what you set
//	private static final String REDIRECT_URI = "http://localhost:8080/callback"; // Make sure this matches what you set
																					// in Azure
